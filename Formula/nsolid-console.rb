class NsolidConsole < Formula
  ...
  url "https://s3-us-west-2.amazonaws.com/nodesource-public-downloads/3.1.0/artifacts/bundles/nsolid-bundle-v3.1.0-darwin-x64/nsolid-console-v3.1.0-darwin-x64.tar.gz"
